...
//console.log(req.body);
var sql = "INSERT INTO tmp_requests (start, end, title, arrival_destination_dateTime, destination_dep_dateTime, arrival_PPU_dateTime, email) VALUES (?,?,?,?,?,?,?);";
var values = [req.body.start, req.body.end, req.body.title, req.body.arrival_destination_dateTime, req.body.destination_dep_dateTime, req.body.arrival_PPU_dateTime, req.body.email];
       con.query(sql, values, function(err, results) {
         if (err) throw err;
         //console.log(results);
